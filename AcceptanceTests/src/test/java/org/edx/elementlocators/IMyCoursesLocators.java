...
public interface IMyCoursesLocators {
	...
	// Find A Course id's
	String btnFindACourseId = "org.proversity.edx.mobile:id/course_btn";
	String btnDontSeeCoursesId = "org.proversity.edx.mobile:id/course_not_listed_tv";
	String btnCloseId = "org.proversity.edx.mobile:id/positiveButton";
	...
	String btnSectionSubsectionDownloadId = "org.proversity.edx.mobile:id/bulk_download_layout";
	...
	String hlnkViewOnWebId = "org.proversity.edx.mobile:id/open_in_browser_btn";
	String btnVideoId = "org.proversity.edx.mobile:id/video_row_layout";
	String btnVideoDownloadId = "org.proversity.edx.mobile:id/video_start_download";

	// Download Screen, Download Message Id's
	String btnDownloadScreenId = "org.proversity.edx.mobile:id/down_arrow";
	String btnDownloadScreenCancelId = "org.proversity.edx.mobile:id/close_btn";
	String dlgLargeDownloadsId = "org.proversity.edx.mobile:id/dialog_layout";
	String lbVideoName = "org.proversity.edx.mobile:id/video_title";
	String lbVideoSize = "org.proversity.edx.mobile:id/video_size";
	String lbVideoLength = "org.proversity.edx.mobile:id/video_playing_time";
	...
	String msgDownloadId = "org.proversity.edx.mobile:id/flying_message";
	String downloadProgressWheel = "org.proversity.edx.mobile:id/progress_wheel";

	// Video player Id's
	String vpVideoPlayerId = "org.proversity.edx.mobile:id/preview";
	String lbVideoNameVideoPlayerId = "org.proversity.edx.mobile:id/video_title";
	...
	String popupLanguages = "org.proversity.edx.mobile:id/row_cc_lang";
	String txtSubtitlesId = "org.proversity.edx.mobile:id/txtSubtitles_tv";
	String popupLanguagesCancel = "org.proversity.edx.mobile:id/tv_cc_cancel";

	// No CourseWare available id
	String lbCourseWareId = "org.proversity.edx.mobile:id/no_chapter_tv";
...
+"Wi-Fi is not available. Data charges may apply.";
	...
	String findACoursewebView="org.proversity.edx.mobile:id/webview";
