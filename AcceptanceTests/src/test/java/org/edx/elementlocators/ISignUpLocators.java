...
public interface ISignUpLocators {
	...
	// Landing screen
	String Android_edXLogoId = "org.proversity.edx.mobile:id/edx_logo";
	String Android_signUpButtonName = "Sign up and start learning";
	String Android_signUpButtonId = "org.proversity.edx.mobile:id/sign_up_btn";
	String Android_signInByName = "Already have an account? Sign in";

	// Sign up page
	String Android_signUpTextByName = "Sign up for edX";
	String Android_closeBtnById = "org.proversity.edx.mobile:id/actionbar_close_btn";
	String Android_createAccountById = "org.proversity.edx.mobile:id/create_account_tv";
	String Android_showOptionalFieldByName = "Show optional fields";
	String Android_createAccountByName = "Create my account";
	String Android_txtAgreeToEULAById = "org.proversity.edx.mobile:id/by_creating_account_tv";
	String Android_EULAById = "org.proversity.edx.mobile:id/end_user_agreement_tv";
